...
<style type="text/css">
	...
	*{font-size: 14px;}
	...
	.vertify-dv{display: flex;border: none;padding-left: 0;}
	.vertify-dv>input{width: 40%; border: 1px solid #eee;border-radius: 3px;height: 98%;padding: 0 5px;}
	.vertify-dv>div{width: 60%;text-align: right;height: 100%;}
	...
	@media screen and (min-width: 768px) {/* .pc-login-dv{display: flex} .mobile-login-dv{display:none}  */.left-picture{display: inline-block;}}
</style>
				...
				<div class="wrap">
					...
					<div id="iPcForms" class="form-group">
						...
						<div class="register-form" id="iPcRegisterForm">
							...
							<div class="vertify-dv">
								<input type="text" name="vertifyCode" placeholder="验证码"/>
								<div class="vertify-image"><img  src=""/></div>
							</div>
